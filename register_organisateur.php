...
<div class="form-container">
    ...
    <form method="POST" id="registerOrganisateurForm">
        ...
        <div class="mb-3">
            ...
            <textarea name="adresse" id="adresse" class="form-control" placeholder="Entrez votre adresse" rows="3" required></textarea>
        </div>
        <div class="mb-3">
            <label for="organisation" class="form-label">Organisation</label>
            <input type="text" name="organisation" id="organisation" class="form-control" placeholder="Nom de votre organisation" required>
        </div>
        <div class="mb-3">
            <label for="mot_de_passe" class="form-label">Mot de passe</label>
            <input type="password" name="mot_de_passe" id="mot_de_passe" class="form-control" placeholder="Entrez un mot de passe" required>
        </div>
